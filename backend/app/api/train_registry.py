...
class TrainRegistry:
    ...
    def initialize_default_fleet(self):
        ...
        catalog = [
            {"id": "12301", "number": "12301", "name": "Howrah Rajdhani Express", "type": "Rajdhani", "zone": "ER", "origin": "New Delhi", "origin_code": "NDLS", "dest": "Howrah Junction", "dest_code": "HWH", "curr": "Kanpur Central", "next": "Prayagraj Junction", "lat": 26.4499, "lng": 80.3319, "speed": 92.0, "delay": 18.0, "covered": 440.0, "total": 1447.0, "weather": 0.35, "rain": 8.0, "congestion": 0.45, "tsr": 0.4, "signal": 0.0},
